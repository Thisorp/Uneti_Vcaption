...
def parse_command_line_arguments():
    ...
    parser = argparse.ArgumentParser(description='CLI for code, some static definition are placed in the VARIABLE.py file')
...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        ...
        dataset = MyDataset(args.dataset_folder, percentage=100)
        print("OK.")
